import{j as M}from"./jsx-runtime.u17CrQMm.js";import{a as Ae}from"./index.UEuQJ2Tp.js";import{p as Lt,m as Bt}from"./preview-switch.C7drxiXe.js";import{p as qt,m as Ft}from"./preview-switch.ndzvl-Ia.js";import{A as jt}from"./index.DUJw84If.js";import{m as Je}from"./proxy.DFvRIZoK.js";const p=Object.freeze({background:{key:"background",id:"backgrounds",name:"Backgrounds"},component:{key:"component",id:"components",name:"Components"},textEffect:{key:"textEffect",id:"text-effects",name:"Text Effects"},visualEffects:{key:"visualEffects",id:"visual-effects",name:"Visual Effects"}}),m=Object.freeze({react:{key:"react",name:"React",icon:"react"},tailwind:{key:"tailwind",name:"Tailwind CSS",icon:"tailwind"},motion:{key:"motion",name:"Motion",icon:"motion"}}),x=t=>({...t}),Wt=`import { useState, useRef, useEffect, useLayoutEffect, useMemo, useCallback } from "react";
...
export default NightSkyBackground;`,Vt=`import NightSkyBackground from "@/registry/backgrounds/night-sky-background/night-sky-background";
...
export default NightSkyBackgroundPreview;`,Zt={};let te=globalThis.process||{},Ge=te.argv||[],H=te.env||{};!(H.NO_COLOR||Ge.includes("--no-color"))&&(H.FORCE_COLOR||Ge.includes("--color")||te.platform==="win32"||(te.stdout||{}).isTTY&&H.TERM!=="dumb"||H.CI);const vt=Symbol.for("astro:html-string");class Xt extends String{[vt]=!0}const wt=t=>Ut(t)?t:typeof t=="string"?new Xt(t):t;function Ut(t){return!!t?.[vt]}typeof process<"u"&&Object.prototype.toString.call(process)==="[object process]"&&(typeof navigator<"u"&&navigator.userAgent);var Ke;(function(t){t[t.Include=0]="Include",t[t.None=1]="None"})(Ke||(Ke={}));var Qe;(function(t){t[t.Required=0]="Required",t[t.Ignore=1]="Ignore"})(Qe||(Qe={}));var en;(function(t){t[t.Include=0]="Include",t[t.None=1]="None"})(en||(en={}));var nn;(function(t){t[t.Required=0]="Required",t[t.Ignore=1]="Ignore"})(nn||(nn={}));var tn;function h(t,e,r){function o(a,d){if(a._zod||Object.defineProperty(a,"_zod",{value:{def:d,constr:s,traits:new Set},enumerable:!1}),a._zod.traits.has(t))return;a._zod.traits.add(t),e(a,d);const l=s.prototype,u=Object.keys(l);for(let y=0;y<u.length;y++){const v=u[y];v in a||(a[v]=l[v].bind(a))}}const i=r?.Parent??Object;class c extends i{}Object.defineProperty(c,"name",{value:t});function s(a){var d;const l=r?.Parent?new c:this;o(l,a),(d=l._zod).deferred??(d.deferred=[]);for(const u of l._zod.deferred)u();return l}return Object.defineProperty(s,"init",{value:o}),Object.defineProperty(s,Symbol.hasInstance,{value:a=>r?.Parent&&a instanceof r.Parent?!0:a?._zod?.traits?.has(t)}),Object.defineProperty(s,"name",{value:t}),s}class A extends Error{constructor(){super("Encountered Promise during synchronous parse. Use .parseAsync() instead.")}}class Ct extends Error{constructor(e){super(`Encountered unidirectional transform during encode: ${e}`),this.name="ZodEncodeError"}}(tn=globalThis).__zod_globalConfig??(tn.__zod_globalConfig={});const Yt=globalThis.__zod_globalConfig;function z(t){return Yt}function kt(t){const e=Object.values(t).filter(o=>typeof o=="number");return Object.entries(t).filter(([o,i])=>e.indexOf(+o)===-1).map(([o,i])=>i)}function qe(t,e){return typeof e=="bigint"?e.toString():e}function Ve(t){return t==null}function Ze(t){const e=t.startsWith("^")?1:0,r=t.endsWith("$")?t.length-1:t.length;return t.slice(e,r)}const rn=Symbol("evaluating");function g(t,e,r){let o;Object.defineProperty(t,e,{get(){if(o!==rn)return o===void 0&&(o=rn,o=r()),o},set(i){Object.defineProperty(t,e,{value:i})},configurable:!0})}function Jt(...t){const e={};for(const r of t){const o=Object.getOwnPropertyDescriptors(r);Object.assign(e,o)}return Object.defineProperties({},e)}const St="captureStackTrace"in Error?Error.captureStackTrace:(...t)=>{};function on(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function Fe(t){if(on(t)===!1)return!1;const e=t.constructor;if(e===void 0||typeof e!="function")return!0;const r=e.prototype;return!(on(r)===!1||Object.prototype.hasOwnProperty.call(r,"isPrototypeOf")===!1)}function Nt(t){return Fe(t)?{...t}:Array.isArray(t)?[...t]:t instanceof Map?new Map(t):t instanceof Set?new Set(t):t}const Gt=new Set(["string","number","symbol"]);function Kt(t){return t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Qt(t,e,r){const o=new t._zod.constr(e??t._zod.def);return(!e||r?.parent)&&(o._zod.parent=t),o}function P(t){const e=t;if(!e)return{};if(typeof e=="string")return{error:()=>e};if(e?.message!==void 0){if(e?.error!==void 0)throw new Error("Cannot specify both `message` and `error` params");e.error=e.message}return delete e.message,typeof e.error=="string"?{...e,error:()=>e.error}:e}function $(t,e=0){if(t.aborted===!0)return!0;for(let r=e;r<t.issues.length;r++)if(t.issues[r]?.continue!==!0)return!0;return!1}function er(t,e=0){if(t.aborted===!0)return!0;for(let r=e;r<t.issues.length;r++)if(t.issues[r]?.continue===!1)return!0;return!1}function nr(t,e){return e.map(r=>{var o;return(o=r).path??(o.path=[]),r.path.unshift(t),r})}function L(t){return typeof t=="string"?t:t?.message}function T(t,e,r){const o=t.message?t.message:L(t.inst?._zod.def?.error?.(t))??L(e?.error?.(t))??L(r.customError?.(t))??L(r.localeError?.(t))??"Invalid input",{inst:i,continue:c,input:s,...a}=t;return a.path??(a.path=[]),a.message=o,e?.reportInput&&(a.input=s),a}function Xe(t){return Array.isArray(t)?"array":typeof t=="string"?"string":"unknown"}function E(...t){const[e,r,o]=t;return typeof e=="string"?{message:e,code:"custom",input:r,inst:o}:{...e}}const Mt=(t,e)=>{t.name="$ZodError",Object.defineProperty(t,"_zod",{value:t._zod,enumerable:!1}),Object.defineProperty(t,"issues",{value:e,enumerable:!1}),t.message=JSON.stringify(e,qe,2),Object.defineProperty(t,"toString",{value:()=>t.message,enumerable:!1})},Pt=h("$ZodError",Mt),It=h("$ZodError",Mt,{Parent:Error});function tr(t,e=r=>r.message){const r={},o=[];for(const i of t.issues)i.path.length>0?(r[i.path[0]]=r[i.path[0]]||[],r[i.path[0]].push(e(i))):o.push(e(i));return{formErrors:o,fieldErrors:r}}function rr(t,e=r=>r.message){const r={_errors:[]},o=(i,c=[])=>{for(const s of i.issues)if(s.code==="invalid_union"&&s.errors.length)s.errors.map(a=>o({issues:a},[...c,...s.path]));else if(s.code==="invalid_key")o({issues:s.issues},[...c,...s.path]);else if(s.code==="invalid_element")o({issues:s.issues},[...c,...s.path]);else{const a=[...c,...s.path];if(a.length===0)r._errors.push(e(s));else{let d=r,l=0;for(;l<a.length;){const u=a[l];l===a.length-1?(d[u]=d[u]||{_errors:[]},d[u]._errors.push(e(s))):d[u]=d[u]||{_errors:[]},d=d[u],l++}}}};return o(t),r}const Ue=t=>(e,r,o,i)=>{const c=o?{...o,async:!1}:{async:!1},s=e._zod.run({value:r,issues:[]},c);if(s instanceof Promise)throw new A;if(s.issues.length){const a=new(i?.Err??t)(s.issues.map(d=>T(d,c,z())));throw St(a,i?.callee),a}return s.value},Ye=t=>async(e,r,o,i)=>{const c=o?{...o,async:!0}:{async:!0};let s=e._zod.run({value:r,issues:[]},c);if(s instanceof Promise&&(s=await s),s.issues.length){const a=new(i?.Err??t)(s.issues.map(d=>T(d,c,z())));throw St(a,i?.callee),a}return s.value},oe=t=>(e,r,o)=>{const i=o?{...o,async:!1}:{async:!1},c=e._zod.run({value:r,issues:[]},i);if(c instanceof Promise)throw new A;return c.issues.length?{success:!1,error:new(t??Pt)(c.issues.map(s=>T(s,i,z())))}:{success:!0,data:c.value}},or=oe(It),ie=t=>async(e,r,o)=>{const i=o?{...o,async:!0}:{async:!0};let c=e._zod.run({value:r,issues:[]},i);return c instanceof Promise&&(c=await c),c.issues.length?{success:!1,error:new t(c.issues.map(s=>T(s,i,z())))}:{success:!0,data:c.value}},ir=ie(It),sr=t=>(e,r,o)=>{const i=o?{...o,direction:"backward"}:{direction:"backward"};return Ue(t)(e,r,i)},cr=t=>(e,r,o)=>Ue(t)(e,r,o),ar=t=>async(e,r,o)=>{const i=o?{...o,direction:"backward"}:{direction:"backward"};return Ye(t)(e,r,i)},dr=t=>async(e,r,o)=>Ye(t)(e,r,o),lr=t=>(e,r,o)=>{const i=o?{...o,direction:"backward"}:{direction:"backward"};return oe(t)(e,r,i)},hr=t=>(e,r,o)=>oe(t)(e,r,o),ur=t=>async(e,r,o)=>{const i=o?{...o,direction:"backward"}:{direction:"backward"};return ie(t)(e,r,i)},mr=t=>async(e,r,o)=>ie(t)(e,r,o),R=h("$ZodCheck",(t,e)=>{var r;t._zod??(t._zod={}),t._zod.def=e,(r=t._zod).onattach??(r.onattach=[])}),pr=h("$ZodCheckMaxLength",(t,e)=>{var r;R.init(t,e),(r=t._zod.def).when??(r.when=o=>{const i=o.value;return!Ve(i)&&i.length!==void 0}),t._zod.onattach.push(o=>{const i=o._zod.bag.maximum??Number.POSITIVE_INFINITY;e.maximum<i&&(o._zod.bag.maximum=e.maximum)}),t._zod.check=o=>{const i=o.value;if(i.length<=e.maximum)return;const s=Xe(i);o.issues.push({origin:s,code:"too_big",maximum:e.maximum,inclusive:!0,input:i,inst:t,continue:!e.abort})}}),fr=h("$ZodCheckMinLength",(t,e)=>{var r;R.init(t,e),(r=t._zod.def).when??(r.when=o=>{const i=o.value;return!Ve(i)&&i.length!==void 0}),t._zod.onattach.push(o=>{const i=o._zod.bag.minimum??Number.NEGATIVE_INFINITY;e.minimum>i&&(o._zod.bag.minimum=e.minimum)}),t._zod.check=o=>{const i=o.value;if(i.length>=e.minimum)return;const s=Xe(i);o.issues.push({origin:s,code:"too_small",minimum:e.minimum,inclusive:!0,input:i,inst:t,continue:!e.abort})}}),gr=h("$ZodCheckLengthEquals",(t,e)=>{var r;R.init(t,e),(r=t._zod.def).when??(r.when=o=>{const i=o.value;return!Ve(i)&&i.length!==void 0}),t._zod.onattach.push(o=>{const i=o._zod.bag;i.minimum=e.length,i.maximum=e.length,i.length=e.length}),t._zod.check=o=>{const i=o.value,c=i.length;if(c===e.length)return;const s=Xe(i),a=c>e.length;o.issues.push({origin:s,...a?{code:"too_big",maximum:e.length}:{code:"too_small",minimum:e.length},inclusive:!0,exact:!0,input:o.value,inst:t,continue:!e.abort})}}),yr=h("$ZodCheckOverwrite",(t,e)=>{R.init(t,e),t._zod.check=r=>{r.value=e.tx(r.value)}}),xr={major:4,minor:4,patch:3},S=h("$ZodType",(t,e)=>{var r;t??(t={}),t._zod.def=e,t._zod.bag=t._zod.bag||{},t._zod.version=xr;const o=[...t._zod.def.checks??[]];t._zod.traits.has("$ZodCheck")&&o.unshift(t);for(const i of o)for(const c of i._zod.onattach)c(t);if(o.length===0)(r=t._zod).deferred??(r.deferred=[]),t._zod.deferred?.push(()=>{t._zod.run=t._zod.parse});else{const i=(s,a,d)=>{let l=$(s),u;for(const y of a){if(y._zod.def.when){if(er(s)||!y._zod.def.when(s))continue}else if(l)continue;const v=s.issues.length,b=y._zod.check(s);if(b instanceof Promise&&d?.async===!1)throw new A;if(u||b instanceof Promise)u=(u??Promise.resolve()).then(async()=>{await b,s.issues.length!==v&&(l||(l=$(s,v)))});else{if(s.issues.length===v)continue;l||(l=$(s,v))}}return u?u.then(()=>s):s},c=(s,a,d)=>{if($(s))return s.aborted=!0,s;const l=i(a,o,d);if(l instanceof Promise){if(d.async===!1)throw new A;return l.then(u=>t._zod.parse(u,d))}return t._zod.parse(l,d)};t._zod.run=(s,a)=>{if(a.skipChecks)return t._zod.parse(s,a);if(a.direction==="backward"){const l=t._zod.parse({value:s.value,issues:[]},{...a,skipChecks:!0});return l instanceof Promise?l.then(u=>c(u,s,a)):c(l,s,a)}const d=t._zod.parse(s,a);if(d instanceof Promise){if(a.async===!1)throw new A;return d.then(l=>i(l,o,a))}return i(d,o,a)}}g(t,"~standard",()=>({validate:i=>{try{const c=or(t,i);return c.success?{value:c.data}:{issues:c.error?.issues}}catch{return ir(t,i).then(s=>s.success?{value:s.data}:{issues:s.error?.issues})}},vendor:"zod",version:1}))});function sn(t,e,r){t.issues.length&&e.issues.push(...nr(r,t.issues)),e.value[r]=t.value}const br=h("$ZodArray",(t,e)=>{S.init(t,e),t._zod.parse=(r,o)=>{const i=r.value;if(!Array.isArray(i))return r.issues.push({expected:"array",code:"invalid_type",input:i,inst:t}),r;r.value=Array(i.length);const c=[];for(let s=0;s<i.length;s++){const a=i[s],d=e.element._zod.run({value:a,issues:[]},o);d instanceof Promise?c.push(d.then(l=>sn(l,r,s))):sn(d,r,s)}return c.length?Promise.all(c).then(()=>r):r}});function cn(t,e,r,o){for(const c of t)if(c.issues.length===0)return e.value=c.value,e;const i=t.filter(c=>!$(c));return i.length===1?(e.value=i[0].value,i[0]):(e.issues.push({code:"invalid_union",input:e.value,inst:r,errors:t.map(c=>c.issues.map(s=>T(s,o,z())))}),e)}const vr=h("$ZodUnion",(t,e)=>{S.init(t,e),g(t._zod,"optin",()=>e.options.some(o=>o._zod.optin==="optional")?"optional":void 0),g(t._zod,"optout",()=>e.options.some(o=>o._zod.optout==="optional")?"optional":void 0),g(t._zod,"values",()=>{if(e.options.every(o=>o._zod.values))return new Set(e.options.flatMap(o=>Array.from(o._zod.values)))}),g(t._zod,"pattern",()=>{if(e.options.every(o=>o._zod.pattern)){const o=e.options.map(i=>i._zod.pattern);return new RegExp(`^(${o.map(i=>Ze(i.source)).join("|")})$`)}});const r=e.options.length===1?e.options[0]._zod.run:null;t._zod.parse=(o,i)=>{if(r)return r(o,i);let c=!1;const s=[];for(const a of e.options){const d=a._zod.run({value:o.value,issues:[]},i);if(d instanceof Promise)s.push(d),c=!0;else{if(d.issues.length===0)return d;s.push(d)}}return c?Promise.all(s).then(a=>cn(a,o,t,i)):cn(s,o,t,i)}}),wr=h("$ZodIntersection",(t,e)=>{S.init(t,e),t._zod.parse=(r,o)=>{const i=r.value,c=e.left._zod.run({value:i,issues:[]},o),s=e.right._zod.run({value:i,issues:[]},o);return c instanceof Promise||s instanceof Promise?Promise.all([c,s]).then(([d,l])=>an(r,d,l)):an(r,c,s)}});function je(t,e){if(t===e)return{valid:!0,data:t};if(t instanceof Date&&e instanceof Date&&+t==+e)return{valid:!0,data:t};if(Fe(t)&&Fe(e)){const r=Object.keys(e),o=Object.keys(t).filter(c=>r.indexOf(c)!==-1),i={...t,...e};for(const c of o){const s=je(t[c],e[c]);if(!s.valid)return{valid:!1,mergeErrorPath:[c,...s.mergeErrorPath]};i[c]=s.data}return{valid:!0,data:i}}if(Array.isArray(t)&&Array.isArray(e)){if(t.length!==e.length)return{valid:!1,mergeErrorPath:[]};const r=[];for(let o=0;o<t.length;o++){const i=t[o],c=e[o],s=je(i,c);if(!s.valid)return{valid:!1,mergeErrorPath:[o,...s.mergeErrorPath]};r.push(s.data)}return{valid:!0,data:r}}return{valid:!1,mergeErrorPath:[]}}function an(t,e,r){const o=new Map;let i;for(const a of e.issues)if(a.code==="unrecognized_keys"){i??(i=a);for(const d of a.keys)o.has(d)||o.set(d,{}),o.get(d).l=!0}else t.issues.push(a);for(const a of r.issues)if(a.code==="unrecognized_keys")for(const d of a.keys)o.has(d)||o.set(d,{}),o.get(d).r=!0;else t.issues.push(a);const c=[...o].filter(([,a])=>a.l&&a.r).map(([a])=>a);if(c.length&&i&&t.issues.push({...i,keys:c}),$(t))return t;const s=je(e.value,r.value);if(!s.valid)throw new Error(`Unmergable intersection. Error path: ${JSON.stringify(s.mergeErrorPath)}`);return t.value=s.data,t}const Cr=h("$ZodEnum",(t,e)=>{S.init(t,e);const r=kt(e.entries),o=new Set(r);t._zod.values=o,t._zod.pattern=new RegExp(`^(${r.filter(i=>Gt.has(typeof i)).map(i=>typeof i=="string"?Kt(i):i.toString()).join("|")})$`),t._zod.parse=(i,c)=>{const s=i.value;return o.has(s)||i.issues.push({code:"invalid_value",values:r,input:s,inst:t}),i}}),kr=h("$ZodTransform",(t,e)=>{S.init(t,e),t._zod.optin="optional",t._zod.parse=(r,o)=>{if(o.direction==="backward")throw new Ct(t.constructor.name);const i=e.transform(r.value,r);if(o.async)return(i instanceof Promise?i:Promise.resolve(i)).then(s=>(r.value=s,r.fallback=!0,r));if(i instanceof Promise)throw new A;return r.value=i,r.fallback=!0,r}});function dn(t,e){return e===void 0&&(t.issues.length||t.fallback)?{issues:[],value:void 0}:t}const _t=h("$ZodOptional",(t,e)=>{S.init(t,e),t._zod.optin="optional",t._zod.optout="optional",g(t._zod,"values",()=>e.innerType._zod.values?new Set([...e.innerType._zod.values,void 0]):void 0),g(t._zod,"pattern",()=>{const r=e.innerType._zod.pattern;return r?new RegExp(`^(${Ze(r.source)})?$`):void 0}),t._zod.parse=(r,o)=>{if(e.innerType._zod.optin==="optional"){const i=r.value,c=e.innerType._zod.run(r,o);return c instanceof Promise?c.then(s=>dn(s,i)):dn(c,i)}return r.value===void 0?r:e.innerType._zod.run(r,o)}}),Sr=h("$ZodExactOptional",(t,e)=>{_t.init(t,e),g(t._zod,"values",()=>e.innerType._zod.values),g(t._zod,"pattern",()=>e.innerType._zod.pattern),t._zod.parse=(r,o)=>e.innerType._zod.run(r,o)}),Nr=h("$ZodNullable",(t,e)=>{S.init(t,e),g(t._zod,"optin",()=>e.innerType._zod.optin),g(t._zod,"optout",()=>e.innerType._zod.optout),g(t._zod,"pattern",()=>{const r=e.innerType._zod.pattern;return r?new RegExp(`^(${Ze(r.source)}|null)$`):void 0}),g(t._zod,"values",()=>e.innerType._zod.values?new Set([...e.innerType._zod.values,null]):void 0),t._zod.parse=(r,o)=>r.value===null?r:e.innerType._zod.run(r,o)}),Mr=h("$ZodDefault",(t,e)=>{S.init(t,e),t._zod.optin="optional",g(t._zod,"values",()=>e.innerType._zod.values),t._zod.parse=(r,o)=>{if(o.direction==="backward")return e.innerType._zod.run(r,o);if(r.value===void 0)return r.value=e.defaultValue,r;const i=e.innerType._zod.run(r,o);return i instanceof Promise?i.then(c=>ln(c,e)):ln(i,e)}});function ln(t,e){return t.value===void 0&&(t.value=e.defaultValue),t}const Pr=h("$ZodPrefault",(t,e)=>{S.init(t,e),t._zod.optin="optional",g(t._zod,"values",()=>e.innerType._zod.values),t._zod.parse=(r,o)=>(o.direction==="backward"||r.value===void 0&&(r.value=e.defaultValue),e.innerType._zod.run(r,o))}),Ir=h("$ZodNonOptional",(t,e)=>{S.init(t,e),g(t._zod,"values",()=>{const r=e.innerType._zod.values;return r?new Set([...r].filter(o=>o!==void 0)):void 0}),t._zod.parse=(r,o)=>{const i=e.innerType._zod.run(r,o);return i instanceof Promise?i.then(c=>hn(c,t)):hn(i,t)}});function hn(t,e){return!t.issues.length&&t.value===void 0&&t.issues.push({code:"invalid_type",expected:"nonoptional",input:t.value,inst:e}),t}const _r=h("$ZodCatch",(t,e)=>{S.init(t,e),t._zod.optin="optional",g(t._zod,"optout",()=>e.innerType._zod.optout),g(t._zod,"values",()=>e.innerType._zod.values),t._zod.parse=(r,o)=>{if(o.direction==="backward")return e.innerType._zod.run(r,o);const i=e.innerType._zod.run(r,o);return i instanceof Promise?i.then(c=>(r.value=c.value,c.issues.length&&(r.value=e.catchValue({...r,error:{issues:c.issues.map(s=>T(s,o,z()))},input:r.value}),r.issues=[],r.fallback=!0),r)):(r.value=i.value,i.issues.length&&(r.value=e.catchValue({...r,error:{issues:i.issues.map(c=>T(c,o,z()))},input:r.value}),r.issues=[],r.fallback=!0),r)}}),zr=h("$ZodPipe",(t,e)=>{S.init(t,e),g(t._zod,"values",()=>e.in._zod.values),g(t._zod,"optin",()=>e.in._zod.optin),g(t._zod,"optout",()=>e.out._zod.optout),g(t._zod,"propValues",()=>e.in._zod.propValues),t._zod.parse=(r,o)=>{if(o.direction==="backward"){const c=e.out._zod.run(r,o);return c instanceof Promise?c.then(s=>B(s,e.in,o)):B(c,e.in,o)}const i=e.in._zod.run(r,o);return i instanceof Promise?i.then(c=>B(c,e.out,o)):B(i,e.out,o)}});function B(t,e,r){return t.issues.length?(t.aborted=!0,t):e._zod.run({value:t.value,issues:t.issues,fallback:t.fallback},r)}const Tr=h("$ZodReadonly",(t,e)=>{S.init(t,e),g(t._zod,"propValues",()=>e.innerType._zod.propValues),g(t._zod,"values",()=>e.innerType._zod.values),g(t._zod,"optin",()=>e.innerType?._zod?.optin),g(t._zod,"optout",()=>e.innerType?._zod?.optout),t._zod.parse=(r,o)=>{if(o.direction==="backward")return e.innerType._zod.run(r,o);const i=e.innerType._zod.run(r,o);return i instanceof Promise?i.then(un):un(i)}});function un(t){return t.value=Object.freeze(t.value),t}const $r=h("$ZodCustom",(t,e)=>{R.init(t,e),S.init(t,e),t._zod.parse=(r,o)=>r,t._zod.check=r=>{const o=r.value,i=e.fn(o);if(i instanceof Promise)return i.then(c=>mn(c,r,o,t));mn(i,r,o,t)}});function mn(t,e,r,o){if(!t){const i={code:"custom",input:r,inst:o,path:[...o._zod.def.path??[]],continue:!o._zod.def.abort};o._zod.def.params&&(i.params=o._zod.def.params),e.issues.push(E(i))}}var pn;class Ar{constructor(){this._map=new WeakMap,this._idmap=new Map}add(e,...r){const o=r[0];return this._map.set(e,o),o&&typeof o=="object"&&"id"in o&&this._idmap.set(o.id,e),this}clear(){return this._map=new WeakMap,this._idmap=new Map,this}remove(e){const r=this._map.get(e);return r&&typeof r=="object"&&"id"in r&&this._idmap.delete(r.id),this._map.delete(e),this}get(e){const r=e._zod.parent;if(r){const o={...this.get(r)??{}};delete o.id;const i={...o,...this._map.get(e)};return Object.keys(i).length?i:void 0}return this._map.get(e)}has(e){return this._map.has(e)}}function Rr(){return new Ar}(pn=globalThis).__zod_globalRegistry??(pn.__zod_globalRegistry=Rr());const O=globalThis.__zod_globalRegistry;function Dr(t,e){return new pr({check:"max_length",...P(e),maximum:t})}function fn(t,e){return new fr({check:"min_length",...P(e),minimum:t})}function Or(t,e){return new gr({check:"length_equals",...P(e),length:t})}function Er(t){return new yr({check:"overwrite",tx:t})}function Hr(t,e,r){return new t({type:"array",element:e,...P(r)})}function Lr(t,e,r){const o=P(r);return o.abort??(o.abort=!0),new t({type:"custom",check:"custom",fn:e,...o})}function Br(t,e,r){return new t({type:"custom",check:"custom",fn:e,...P(r)})}function qr(t,e){const r=Fr(o=>(o.addIssue=i=>{if(typeof i=="string")o.issues.push(E(i,o.value,r._zod.def));else{const c=i;c.fatal&&(c.continue=!1),c.code??(c.code="custom"),c.input??(c.input=o.value),c.inst??(c.inst=r),c.continue??(c.continue=!r._zod.def.abort),o.issues.push(E(c))}},t(o.value,o)),e);return r}function Fr(t,e){const r=new R({check:"custom",...P(e)});return r._zod.check=t,r}function zt(t){let e=t?.target??"draft-2020-12";return e==="draft-4"&&(e="draft-04"),e==="draft-7"&&(e="draft-07"),{processors:t.processors??{},metadataRegistry:t?.metadata??O,target:e,unrepresentable:t?.unrepresentable??"throw",override:t?.override??(()=>{}),io:t?.io??"output",counter:0,seen:new Map,cycles:t?.cycles??"ref",reused:t?.reused??"inline",external:t?.external??void 0}}function k(t,e,r={path:[],schemaPath:[]}){var o;const i=t._zod.def,c=e.seen.get(t);if(c)return c.count++,r.schemaPath.includes(t)&&(c.cycle=r.path),c.schema;const s={schema:{},count:1,cycle:void 0,path:r.path};e.seen.set(t,s);const a=t._zod.toJSONSchema?.();if(a)s.schema=a;else{const u={...r,schemaPath:[...r.schemaPath,t],path:r.path};if(t._zod.processJSONSchema)t._zod.processJSONSchema(e,s.schema,u);else{const v=s.schema,b=e.processors[i.type];if(!b)throw new Error(`[toJSONSchema]: Non-representable type encountered: ${i.type}`);b(t,e,v,u)}const y=t._zod.parent;y&&(s.ref||(s.ref=y),k(y,e,u),e.seen.get(y).isParent=!0)}const d=e.metadataRegistry.get(t);return d&&Object.assign(s.schema,d),e.io==="input"&&C(t)&&(delete s.schema.examples,delete s.schema.default),e.io==="input"&&"_prefault"in s.schema&&((o=s.schema).default??(o.default=s.schema._prefault)),delete s.schema._prefault,e.seen.get(t).schema}function Tt(t,e){const r=t.seen.get(e);if(!r)throw new Error("Unprocessed schema. This is a bug in Zod.");const o=new Map;for(const s of t.seen.entries()){const a=t.metadataRegistry.get(s[0])?.id;if(a){const d=o.get(a);if(d&&d!==s[0])throw new Error(`Duplicate schema id "${a}" detected during JSON Schema conversion. Two different schemas cannot share the same id when converted together.`);o.set(a,s[0])}}const i=s=>{const a=t.target==="draft-2020-12"?"$defs":"definitions";if(t.external){const y=t.external.registry.get(s[0])?.id,v=t.external.uri??(w=>w);if(y)return{ref:v(y)};const b=s[1].defId??s[1].schema.id??`schema${t.counter++}`;return s[1].defId=b,{defId:b,ref:`${v("__shared")}#/${a}/${b}`}}if(s[1]===r)return{ref:"#"};const l=`#/${a}/`,u=s[1].schema.id??`__schema${t.counter++}`;return{defId:u,ref:l+u}},c=s=>{if(s[1].schema.$ref)return;const a=s[1],{ref:d,defId:l}=i(s);a.def={...a.schema},l&&(a.defId=l);const u=a.schema;for(const y in u)delete u[y];u.$ref=d};if(t.cycles==="throw")for(const s of t.seen.entries()){const a=s[1];if(a.cycle)throw new Error(`Cycle detected: #/${a.cycle?.join("/")}/<root>

Set the \`cycles\` parameter to \`"ref"\` to resolve cyclical schemas with defs.`)}for(const s of t.seen.entries()){const a=s[1];if(e===s[0]){c(s);continue}if(t.external){const l=t.external.registry.get(s[0])?.id;if(e!==s[0]&&l){c(s);continue}}if(t.metadataRegistry.get(s[0])?.id){c(s);continue}if(a.cycle){c(s);continue}if(a.count>1&&t.reused==="ref"){c(s);continue}}}function $t(t,e){const r=t.seen.get(e);if(!r)throw new Error("Unprocessed schema. This is a bug in Zod.");const o=a=>{const d=t.seen.get(a);if(d.ref===null)return;const l=d.def??d.schema,u={...l},y=d.ref;if(d.ref=null,y){o(y);const b=t.seen.get(y),w=b.schema;if(w.$ref&&(t.target==="draft-07"||t.target==="draft-04"||t.target==="openapi-3.0")?(l.allOf=l.allOf??[],l.allOf.push(w)):Object.assign(l,w),Object.assign(l,u),a._zod.parent===y)for(const _ in l)_==="$ref"||_==="allOf"||_ in u||delete l[_];if(w.$ref&&b.def)for(const _ in l)_==="$ref"||_==="allOf"||_ in b.def&&JSON.stringify(l[_])===JSON.stringify(b.def[_])&&delete l[_]}const v=a._zod.parent;if(v&&v!==y){o(v);const b=t.seen.get(v);if(b?.schema.$ref&&(l.$ref=b.schema.$ref,b.def))for(const w in l)w==="$ref"||w==="allOf"||w in b.def&&JSON.stringify(l[w])===JSON.stringify(b.def[w])&&delete l[w]}t.override({zodSchema:a,jsonSchema:l,path:d.path??[]})};for(const a of[...t.seen.entries()].reverse())o(a[0]);const i={};if(t.target==="draft-2020-12"?i.$schema="https://json-schema.org/draft/2020-12/schema":t.target==="draft-07"?i.$schema="http://json-schema.org/draft-07/schema#":t.target==="draft-04"?i.$schema="http://json-schema.org/draft-04/schema#":t.target,t.external?.uri){const a=t.external.registry.get(e)?.id;if(!a)throw new Error("Schema is missing an `id` property");i.$id=t.external.uri(a)}Object.assign(i,r.def??r.schema);const c=t.metadataRegistry.get(e)?.id;c!==void 0&&i.id===c&&delete i.id;const s=t.external?.defs??{};for(const a of t.seen.entries()){const d=a[1];d.def&&d.defId&&(d.def.id===d.defId&&delete d.def.id,s[d.defId]=d.def)}t.external||Object.keys(s).length>0&&(t.target==="draft-2020-12"?i.$defs=s:i.definitions=s);try{const a=JSON.parse(JSON.stringify(i));return Object.defineProperty(a,"~standard",{value:{...e["~standard"],jsonSchema:{input:re(e,"input",t.processors),output:re(e,"output",t.processors)}},enumerable:!1,writable:!1}),a}catch{throw new Error("Error converting schema to JSON.")}}function C(t,e){const r=e??{seen:new Set};if(r.seen.has(t))return!1;r.seen.add(t);const o=t._zod.def;if(o.type==="transform")return!0;if(o.type==="array")return C(o.element,r);if(o.type==="set")return C(o.valueType,r);if(o.type==="lazy")return C(o.getter(),r);if(o.type==="promise"||o.type==="optional"||o.type==="nonoptional"||o.type==="nullable"||o.type==="readonly"||o.type==="default"||o.type==="prefault")return C(o.innerType,r);if(o.type==="intersection")return C(o.left,r)||C(o.right,r);if(o.type==="record"||o.type==="map")return C(o.keyType,r)||C(o.valueType,r);if(o.type==="pipe")return t._zod.traits.has("$ZodCodec")?!0:C(o.in,r)||C(o.out,r);if(o.type==="object"){for(const i in o.shape)if(C(o.shape[i],r))return!0;return!1}if(o.type==="union"){for(const i of o.options)if(C(i,r))return!0;return!1}if(o.type==="tuple"){for(const i of o.items)if(C(i,r))return!0;return!!(o.rest&&C(o.rest,r))}return!1}const jr=(t,e={})=>r=>{const o=zt({...r,processors:e});return k(t,o),Tt(o,t),$t(o,t)},re=(t,e,r={})=>o=>{const{libraryOptions:i,target:c}=o??{},s=zt({...i??{},target:c,io:e,processors:r});return k(t,s),Tt(s,t),$t(s,t)},Wr=(t,e,r,o)=>{const i=t._zod.def,c=kt(i.entries);c.every(s=>typeof s=="number")&&(r.type="number"),c.every(s=>typeof s=="string")&&(r.type="string"),r.enum=c},Vr=(t,e,r,o)=>{if(e.unrepresentable==="throw")throw new Error("Custom types cannot be represented in JSON Schema")},Zr=(t,e,r,o)=>{if(e.unrepresentable==="throw")throw new Error("Transforms cannot be represented in JSON Schema")},Xr=(t,e,r,o)=>{const i=r,c=t._zod.def,{minimum:s,maximum:a}=t._zod.bag;typeof s=="number"&&(i.minItems=s),typeof a=="number"&&(i.maxItems=a),i.type="array",i.items=k(c.element,e,{...o,path:[...o.path,"items"]})},Ur=(t,e,r,o)=>{const i=t._zod.def,c=i.inclusive===!1,s=i.options.map((a,d)=>k(a,e,{...o,path:[...o.path,c?"oneOf":"anyOf",d]}));c?r.oneOf=s:r.anyOf=s},Yr=(t,e,r,o)=>{const i=t._zod.def,c=k(i.left,e,{...o,path:[...o.path,"allOf",0]}),s=k(i.right,e,{...o,path:[...o.path,"allOf",1]}),a=l=>"allOf"in l&&Object.keys(l).length===1,d=[...a(c)?c.allOf:[c],...a(s)?s.allOf:[s]];r.allOf=d},Jr=(t,e,r,o)=>{const i=t._zod.def,c=k(i.innerType,e,o),s=e.seen.get(t);e.target==="openapi-3.0"?(s.ref=i.innerType,r.nullable=!0):r.anyOf=[c,{type:"null"}]},Gr=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType},Kr=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType,r.default=JSON.parse(JSON.stringify(i.defaultValue))},Qr=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType,e.io==="input"&&(r._prefault=JSON.parse(JSON.stringify(i.defaultValue)))},eo=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType;let s;try{s=i.catchValue(void 0)}catch{throw new Error("Dynamic catch values are not supported in JSON Schema")}r.default=s},no=(t,e,r,o)=>{const i=t._zod.def,c=i.in._zod.traits.has("$ZodTransform"),s=e.io==="input"?c?i.out:i.in:i.out;k(s,e,o);const a=e.seen.get(t);a.ref=s},to=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType,r.readOnly=!0},At=(t,e,r,o)=>{const i=t._zod.def;k(i.innerType,e,o);const c=e.seen.get(t);c.ref=i.innerType},ro=(t,e)=>{Pt.init(t,e),t.name="ZodError",Object.defineProperties(t,{format:{value:r=>rr(t,r)},flatten:{value:r=>tr(t,r)},addIssue:{value:r=>{t.issues.push(r),t.message=JSON.stringify(t.issues,qe,2)}},addIssues:{value:r=>{t.issues.push(...r),t.message=JSON.stringify(t.issues,qe,2)}},isEmpty:{get(){return t.issues.length===0}}})},I=h("ZodError",ro,{Parent:Error}),oo=Ue(I),io=Ye(I),so=oe(I),co=ie(I),ao=sr(I),lo=cr(I),ho=ar(I),uo=dr(I),mo=lr(I),po=hr(I),fo=ur(I),go=mr(I),gn=new WeakMap;function Rt(t,e,r){const o=Object.getPrototypeOf(t);let i=gn.get(o);if(i||(i=new Set,gn.set(o,i)),!i.has(e)){i.add(e);for(const c in r){const s=r[c];Object.defineProperty(o,c,{configurable:!0,enumerable:!1,get(){const a=s.bind(this);return Object.defineProperty(this,c,{configurable:!0,writable:!0,enumerable:!0,value:a}),a},set(a){Object.defineProperty(this,c,{configurable:!0,writable:!0,enumerable:!0,value:a})}})}}}const N=h("ZodType",(t,e)=>(S.init(t,e),Object.assign(t["~standard"],{jsonSchema:{input:re(t,"input"),output:re(t,"output")}}),t.toJSONSchema=jr(t,{}),t.def=e,t.type=e.type,Object.defineProperty(t,"_def",{value:e}),t.parse=(r,o)=>oo(t,r,o,{callee:t.parse}),t.safeParse=(r,o)=>so(t,r,o),t.parseAsync=async(r,o)=>io(t,r,o,{callee:t.parseAsync}),t.safeParseAsync=async(r,o)=>co(t,r,o),t.spa=t.safeParseAsync,t.encode=(r,o)=>ao(t,r,o),t.decode=(r,o)=>lo(t,r,o),t.encodeAsync=async(r,o)=>ho(t,r,o),t.decodeAsync=async(r,o)=>uo(t,r,o),t.safeEncode=(r,o)=>mo(t,r,o),t.safeDecode=(r,o)=>po(t,r,o),t.safeEncodeAsync=async(r,o)=>fo(t,r,o),t.safeDecodeAsync=async(r,o)=>go(t,r,o),Rt(t,"ZodType",{check(...r){const o=this.def;return this.clone(Jt(o,{checks:[...o.checks??[],...r.map(i=>typeof i=="function"?{_zod:{check:i,def:{check:"custom"},onattach:[]}}:i)]}),{parent:!0})},with(...r){return this.check(...r)},clone(r,o){return Qt(this,r,o)},brand(){return this},register(r,o){return r.add(this,o),this},refine(r,o){return this.check(Fo(r,o))},superRefine(r,o){return this.check(jo(r,o))},overwrite(r){return this.check(Er(r))},optional(){return yn(this)},exactOptional(){return Io(this)},nullable(){return xn(this)},nullish(){return yn(xn(this))},nonoptional(r){return Do(this,r)},array(){return xo(this)},or(r){return vo([this,r])},and(r){return Co(this,r)},transform(r){return bn(this,No(r))},default(r){return To(this,r)},prefault(r){return Ao(this,r)},catch(r){return Eo(this,r)},pipe(r){return bn(this,r)},readonly(){return Bo(this)},describe(r){const o=this.clone();return O.add(o,{description:r}),o},meta(...r){if(r.length===0)return O.get(this);const o=this.clone();return O.add(o,r[0]),o},isOptional(){return this.safeParse(void 0).success},isNullable(){return this.safeParse(null).success},apply(r){return r(this)}}),Object.defineProperty(t,"description",{get(){return O.get(t)?.description},configurable:!0}),t)),yo=h("ZodArray",(t,e)=>{br.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Xr(t,r,o,i),t.element=e.element,Rt(t,"ZodArray",{min(r,o){return this.check(fn(r,o))},nonempty(r){return this.check(fn(1,r))},max(r,o){return this.check(Dr(r,o))},length(r,o){return this.check(Or(r,o))},unwrap(){return this.element}})});function xo(t,e){return Hr(yo,t,e)}const bo=h("ZodUnion",(t,e)=>{vr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Ur(t,r,o,i),t.options=e.options});function vo(t,e){return new bo({type:"union",options:t,...P(e)})}const wo=h("ZodIntersection",(t,e)=>{wr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Yr(t,r,o,i)});function Co(t,e){return new wo({type:"intersection",left:t,right:e})}const We=h("ZodEnum",(t,e)=>{Cr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(o,i,c)=>Wr(t,o,i),t.enum=e.entries,t.options=Object.values(e.entries);const r=new Set(Object.keys(e.entries));t.extract=(o,i)=>{const c={};for(const s of o)if(r.has(s))c[s]=e.entries[s];else throw new Error(`Key ${s} not found in enum`);return new We({...e,checks:[],...P(i),entries:c})},t.exclude=(o,i)=>{const c={...e.entries};for(const s of o)if(r.has(s))delete c[s];else throw new Error(`Key ${s} not found in enum`);return new We({...e,checks:[],...P(i),entries:c})}});function ko(t,e){const r=Array.isArray(t)?Object.fromEntries(t.map(o=>[o,o])):t;return new We({type:"enum",entries:r,...P(e)})}const So=h("ZodTransform",(t,e)=>{kr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Zr(t,r),t._zod.parse=(r,o)=>{if(o.direction==="backward")throw new Ct(t.constructor.name);r.addIssue=c=>{if(typeof c=="string")r.issues.push(E(c,r.value,e));else{const s=c;s.fatal&&(s.continue=!1),s.code??(s.code="custom"),s.input??(s.input=r.value),s.inst??(s.inst=t),r.issues.push(E(s))}};const i=e.transform(r.value,r);return i instanceof Promise?i.then(c=>(r.value=c,r.fallback=!0,r)):(r.value=i,r.fallback=!0,r)}});function No(t){return new So({type:"transform",transform:t})}const Mo=h("ZodOptional",(t,e)=>{_t.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>At(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function yn(t){return new Mo({type:"optional",innerType:t})}const Po=h("ZodExactOptional",(t,e)=>{Sr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>At(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function Io(t){return new Po({type:"optional",innerType:t})}const _o=h("ZodNullable",(t,e)=>{Nr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Jr(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function xn(t){return new _o({type:"nullable",innerType:t})}const zo=h("ZodDefault",(t,e)=>{Mr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Kr(t,r,o,i),t.unwrap=()=>t._zod.def.innerType,t.removeDefault=t.unwrap});function To(t,e){return new zo({type:"default",innerType:t,get defaultValue(){return typeof e=="function"?e():Nt(e)}})}const $o=h("ZodPrefault",(t,e)=>{Pr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Qr(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function Ao(t,e){return new $o({type:"prefault",innerType:t,get defaultValue(){return typeof e=="function"?e():Nt(e)}})}const Ro=h("ZodNonOptional",(t,e)=>{Ir.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Gr(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function Do(t,e){return new Ro({type:"nonoptional",innerType:t,...P(e)})}const Oo=h("ZodCatch",(t,e)=>{_r.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>eo(t,r,o,i),t.unwrap=()=>t._zod.def.innerType,t.removeCatch=t.unwrap});function Eo(t,e){return new Oo({type:"catch",innerType:t,catchValue:typeof e=="function"?e:()=>e})}const Ho=h("ZodPipe",(t,e)=>{zr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>no(t,r,o,i),t.in=e.in,t.out=e.out});function bn(t,e){return new Ho({type:"pipe",in:t,out:e})}const Lo=h("ZodReadonly",(t,e)=>{Tr.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>to(t,r,o,i),t.unwrap=()=>t._zod.def.innerType});function Bo(t){return new Lo({type:"readonly",innerType:t})}const Dt=h("ZodCustom",(t,e)=>{$r.init(t,e),N.init(t,e),t._zod.processJSONSchema=(r,o,i)=>Vr(t,r)});function qo(t,e){return Lr(Dt,t??(()=>!0),e)}function Fo(t,e={}){return Br(Dt,t,e)}function jo(t,e){return qr(t,e)}const vn={custom:"custom"},Wo={"SHA-256":"sha256-","SHA-384":"sha384-","SHA-512":"sha512-"};ko(Object.keys(Wo)).optional().default("SHA-256");const wn=["base-uri","child-src","connect-src","default-src","fenced-frame-src","font-src","form-action","frame-ancestors","frame-src","img-src","manifest-src","media-src","object-src","referrer","report-to","report-uri","require-trusted-types-for","sandbox","trusted-types","upgrade-insecure-requests","worker-src"];qo(t=>typeof t=="string").superRefine((t,e)=>{wn.some(o=>t.startsWith(o))||(t.startsWith("script-src")||t.startsWith("style-src")?e.addIssue({code:vn.custom,message:"Directives `script-src` and `style-src` are not allowed in `security.csp.directives`. Please use `security.csp.scriptDirective` and `security.csp.styleDirective` instead.",fatal:!0}):e.addIssue({code:vn.custom,message:`Invalid directive: "${t}". Allowed directives are: ${wn.join(", ")}`,fatal:!0}))});new TextEncoder;new TextDecoder;wt(`async function replaceServerIsland(id, r) {
...
`).map(t=>t.trim()).filter(t=>t&&!t.startsWith("//")).join(" "));const f=Symbol.for("astro:fragment"),Vo=Symbol.for("astro:renderer");new TextEncoder;new TextDecoder;"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_".split("").reduce((t,e)=>(t[e.charCodeAt(0)]=e,t),[]);"-0123456789_".split("").reduce((t,e)=>(t[e.charCodeAt(0)]=e,t),[]);const Ot="astro:jsx",Cn=Symbol("empty"),kn=t=>t;function Re(t){return t&&typeof t=="object"&&t[Ot]}function Zo(t){if(typeof t.type=="string")return t;const e={};if(Re(t.props.children)){const r=t.props.children;if(!Re(r)||!("slot"in r.props))return;const o=kn(r.props.slot);e[o]=[r],e[o].$$slot=!0,delete r.props.slot,delete t.props.children}else Array.isArray(t.props.children)&&(t.props.children=t.props.children.map(r=>{if(!Re(r)||!("slot"in r.props))return r;const o=kn(r.props.slot);return Array.isArray(e[o])?e[o].push(r):(e[o]=[r],e[o].$$slot=!0),delete r.props.slot,Cn}).filter(r=>r!==Cn));Object.assign(t.props,e)}function Et(t){return typeof t=="string"?wt(t):Array.isArray(t)?t.map(e=>Et(e)):t}function Xo(t){if("set:html"in t.props||"set:text"in t.props){if("set:html"in t.props){const e=Et(t.props["set:html"]);delete t.props["set:html"],Object.assign(t.props,{children:e});return}if("set:text"in t.props){const e=t.props["set:text"];delete t.props["set:text"],Object.assign(t.props,{children:e});return}}}function n(t,e={},r){const o={[Vo]:"astro:jsx",[Ot]:!0,type:t,props:e};return Xo(o),Zo(o),o}const Uo={};function Sn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"density"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"1"})}),n(e.td,{children:"Controls the number of stars rendered in the background. Min: 0.1, Max: 10. Higher = denser sky."})]}),n(e.tr,{children:[n(e.td,{children:"spaceColor"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:'"rgb(0, 0, 0)"'})}),n(e.td,{children:["Sets the background color of the space. Accepts any valid CSS color value (e.g., ",n(e.code,{children:"rgb()"}),", ",n(e.code,{children:"#000"}),", ",n(e.code,{children:"black"}),", ",n(e.code,{children:"hsl()"}),")."]})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the main container."})]})]})]})}function Yo(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(Sn,{...t})}):Sn(t)}const se=(t={})=>Yo({...t,components:{Fragment:f,...t.components}});se[Symbol.for("mdx-component")]=!0;se[Symbol.for("astro.needsHeadRendering")]=!Uo.layout;se.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/backgrounds/night-sky-background/props.mdx";const q="night-sky-background",Nn=x({id:q,name:"Night Sky",description:"A dynamic night sky background with twinkling stars, customizable density, and content layered on top.",category:p.background.id,dependencies:[m.tailwind.key],preview:Zt,previewClassName:"grid place-items-center",source:[{name:`${q}.tsx`,content:Wt,lang:"tsx"}],usage:[{name:`${q}-preview.tsx`,content:Vt,lang:"tsx"}],componentsAPI:[{name:`${q}.tsx`,props:se}]}),Jo=`import { useRef, useState, useEffect, useLayoutEffect, useMemo, memo, useCallback } from "react";
import cn from "@/utils/cn";
...
export default memo(StarFieldBackground);`,Go=`import StarFieldBackground from "@/registry/backgrounds/star-field-background/star-field-background";
...
export default memo(WavyThreadsBackground);`,ti=`import WavyThreadsBackground from "@/registry/backgrounds/wavy-threads-background/wavy-threads-background";
...
export default memo(ArcCards) as typeof ArcCards;`,ci=`import ArcCards from "@/registry/components/arc-cards/arc-cards";
...
`,ai={},di={};function zn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"items"}),n(e.td,{children:n(e.code,{children:"T[]"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:["Array of data items used to render cards. Odd numbers of items are preferred because the middle item (",n(e.code,{children:"items.length / 2"}),") is treated as the center card of the arc layout."]})]}),n(e.tr,{children:[n(e.td,{children:"CardComponent"}),n(e.td,{children:n(e.code,{children:"ComponentType<{ item: T }>"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:["React component used to render each card. Receives a single ",n(e.code,{children:"item"})," prop containing the corresponding item from ",n(e.code,{children:"items"}),"."]})]}),n(e.tr,{children:[n(e.td,{children:"xOffset"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"50"})}),n(e.td,{children:"Horizontal offset applied between cards to create the arc spacing effect."})]}),n(e.tr,{children:[n(e.td,{children:"rotateOffset"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"20"})}),n(e.td,{children:"Rotation angle offset applied to cards based on their position relative to the center card."})]}),n(e.tr,{children:[n(e.td,{children:"scaleOffset"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"0.125"})}),n(e.td,{children:"Scale difference applied between cards. Cards further from the center are scaled down by this offset."})]}),n(e.tr,{children:[n(e.td,{children:"blurOffset"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"0.5"})}),n(e.td,{children:"Blur intensity offset applied to cards based on their distance from the center card."})]})]})]})}function li(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(zn,{...t})}):zn(t)}const de=(t={})=>li({...t,components:{Fragment:f,...t.components}});de[Symbol.for("mdx-component")]=!0;de[Symbol.for("astro.needsHeadRendering")]=!di.layout;de.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/arc-cards/props.mdx";const W="arc-cards",Tn=x({id:W,name:"Arc Cards",description:"A fluid hover animation component that arranges cards along an arc with dynamic scaling, rotation, and blur transitions.",category:p.component.id,dependencies:[m.tailwind.key,m.motion.key],preview:ai,previewClassName:"grid place-items-center",source:[{name:`${W}.tsx`,content:si,lang:"tsx"}],usage:[{name:`${W}-preview.tsx`,content:ci,lang:"tsx"}],componentsAPI:[{name:`${W}.tsx`,props:de}]}),hi=`import { Children, memo } from "react";
...
export default memo(CircularList);`,ui=`import CircularList from "@/registry/components/circular-list/circular-list";
...
export default memo(DeckCarousel);`,yi=`import DeckCarousel, { DeckCarouselItem } from "@/registry/components/deck-carousel/deck-carousel";
...
export default memo(FloatingActionMenu);`,Si=`import FloatingActionMenu, { FloatingActionMenuItem } from "@/registry/components/floating-action-menu/floating-action-menu";
...
export default FloatingActionMenuPreview;`,Ni={},Mi={};function En(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:["One or more ",n(e.code,{children:"FloatingActionMenuItem"})," components to display in the menu."]})]}),n(e.tr,{children:[n(e.td,{children:"radius"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"640"})}),n(e.td,{children:"Radius of the imaginary circle used to position menu items. A larger radius creates a flatter arc, while a smaller radius creates a more curved layout. Adjust this based on the number of menu items and the desired curvature."})]}),n(e.tr,{children:[n(e.td,{children:"gap"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"4"})}),n(e.td,{children:"Angular gap (in degrees) between adjacent menu items. Increase the gap to spread items farther apart or decrease it to make the menu more compact. Tune this according to the number of menu items."})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the menu container."})]}),n(e.tr,{children:[n(e.td,{children:"actionButtonClassName"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the floating action button."})]})]})]})}function Pi(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(En,{...t})}):En(t)}const me=(t={})=>Pi({...t,components:{Fragment:f,...t.components}});me[Symbol.for("mdx-component")]=!0;me[Symbol.for("astro.needsHeadRendering")]=!Mi.layout;me.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/floating-action-menu/FloatingActionMenu-props.mdx";const Ii={};function Hn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"icon"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Content displayed as the menu item’s icon."})]}),n(e.tr,{children:[n(e.td,{children:"name"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Text label displayed for the menu item."})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the menu item."})]})]})]})}function _i(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(Hn,{...t})}):Hn(t)}const pe=(t={})=>_i({...t,components:{Fragment:f,...t.components}});pe[Symbol.for("mdx-component")]=!0;pe[Symbol.for("astro.needsHeadRendering")]=!Ii.layout;pe.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/floating-action-menu/FloatingActionMenuItem-props.mdx";const Oe="floating-action-menu",Ln=x({id:Oe,name:"Floating Action Menu",description:"A customizable floating action menu that arranges items along a curved arc with configurable radius and spacing.",category:p.component.id,dependencies:[m.tailwind.key,m.motion.key],preview:Ni,previewClassName:"grid place-items-center",source:[{name:`${Oe}.tsx`,content:ki,lang:"tsx"}],usage:[{name:`${Oe}-preview.tsx`,content:Si,lang:"tsx"}],componentsAPI:[{name:"FloatingActionMenu",props:me},{name:"FloatingActionMenuItem",props:pe}]}),zi=`import { type ReactNode, type MouseEvent, memo, useState, useRef, useContext, createContext, useCallback, useMemo } from "react";
...
export default memo(FluidDock);`,Ti=`import FluidDock, { FluidDockItem } from "@/registry/components/fluid-dock/fluid-dock";
...
export default FluidDockPreview;`,$i={},Ai={};function Bn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:["The ",n(e.code,{children:"FluidDockItem"})," components rendered inside the dock."]})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the dock container."})]}),n(e.tr,{children:[n(e.td,{children:"itemSize"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"40"})}),n(e.td,{children:"Base size (in pixels) of each dock item before magnification."})]}),n(e.tr,{children:[n(e.td,{children:"magnificationScale"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"1.5"})}),n(e.td,{children:"Maximum scale applied to a dock item when hovered."})]}),n(e.tr,{children:[n(e.td,{children:"padding"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"8"})}),n(e.td,{children:"Inner padding (in pixels) of the dock container."})]}),n(e.tr,{children:[n(e.td,{children:"style"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to the dock container."})]})]})]})}function Ri(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(Bn,{...t})}):Bn(t)}const fe=(t={})=>Ri({...t,components:{Fragment:f,...t.components}});fe[Symbol.for("mdx-component")]=!0;fe[Symbol.for("astro.needsHeadRendering")]=!Ai.layout;fe.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/fluid-dock/FluidDock-props.mdx";const Di={};function qn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:"The content of the dock item, typically an icon or image."})]}),n(e.tr,{children:[n(e.td,{children:"tooltip"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Content displayed in the tooltip when the item is hovered."})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the dock item."})]}),n(e.tr,{children:[n(e.td,{children:"tooltipClassName"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the tooltip."})]}),n(e.tr,{children:[n(e.td,{children:"style"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to the dock item."})]})]})]})}function Oi(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(qn,{...t})}):qn(t)}const ge=(t={})=>Oi({...t,components:{Fragment:f,...t.components}});ge[Symbol.for("mdx-component")]=!0;ge[Symbol.for("astro.needsHeadRendering")]=!Di.layout;ge.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/fluid-dock/FluidDockItem-props.mdx";const Ee="fluid-dock",Fn=x({id:Ee,name:"Fluid Dock",description:"A modern dock navigation with fluid hover animations and interactive tooltips.",category:p.component.id,dependencies:[m.tailwind.key,m.motion.key],preview:$i,previewClassName:"grid place-items-center",source:[{name:`${Ee}.tsx`,content:zi,lang:"tsx"}],usage:[{name:`${Ee}-preview.tsx`,content:Ti,lang:"tsx"}],componentsAPI:[{name:"FluidDock",props:fe},{name:"FluidDockItem",props:ge}]}),Ei=`import { memo } from "react";
import cn from "@/utils/cn";
...
export default memo(Marquee);`,Hi=`@keyframes marquee-list-horizontal-keyframes {
  from {
...
export default memo(SectionNavigator);`,ji=`import SectionNavigator from "@/registry/components/section-navigator/section-navigator";
...
export default memo(Tilt3D);`,Ui=`import Tilt3D, { Tilt3DElement } from "@/registry/components/tilt-3d/tilt-3d";
...
export default Tilt3DPreview;`,Yi={},Ji={};function Xn(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"–"}),n(e.td,{children:"Content rendered inside the 3D tilt container."})]}),n(e.tr,{children:[n(e.td,{children:"tiltX"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"25"})}),n(e.td,{children:"Controls the horizontal (X-axis) tilt angle of the 3D effect."})]}),n(e.tr,{children:[n(e.td,{children:"tiltY"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"25"})}),n(e.td,{children:"Controls the vertical (Y-axis) tilt angle of the 3D effect."})]}),n(e.tr,{children:[n(e.td,{children:"wrapperProps"}),n(e.td,{children:n(e.code,{children:"React.HTMLAttributes<HTMLDivElement>"})}),n(e.td,{children:"No"}),n(e.td,{children:"–"}),n(e.td,{children:["Props forwarded to the wrapper element, including attributes like ",n(e.code,{children:"className"}),", ",n(e.code,{children:"style"}),", ",n(e.code,{children:"id"}),", and event handlers."]})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"–"}),n(e.td,{children:"Additional CSS classes applied to the wrapper element."})]})]})]})}function Gi(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(Xn,{...t})}):Xn(t)}const be=(t={})=>Gi({...t,components:{Fragment:f,...t.components}});be[Symbol.for("mdx-component")]=!0;be[Symbol.for("astro.needsHeadRendering")]=!Ji.layout;be.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/tilt-3d/props-Tild3D.mdx";const Ki={};function Un(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"z"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"0"})}),n(e.td,{children:["Z-axis translation value applied when the parent ",n(e.code,{children:"Tilt3D"})," component is hovered. Higher values make the element appear elevated."]})]}),n(e.tr,{children:[n(e.td,{children:"as"}),n(e.td,{children:n(e.code,{children:"keyof typeof motion"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:'"div"'})}),n(e.td,{children:"Motion element type to render. Supports any HTML element available through Framer Motion."})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"–"}),n(e.td,{children:"Additional CSS classes applied to the element."})]})]})]})}function Qi(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(Un,{...t})}):Un(t)}const ve=(t={})=>Qi({...t,components:{Fragment:f,...t.components}});ve[Symbol.for("mdx-component")]=!0;ve[Symbol.for("astro.needsHeadRendering")]=!Ki.layout;ve.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/components/tilt-3d/props-Tild3DElement.mdx";const He="tilt-3d",Yn=x({id:He,name:"Tilt 3D",description:"A smooth 3D hover effect that brings interface elements to life with depth and motion.",category:p.component.id,dependencies:[m.tailwind.key,m.motion.key],preview:Yi,previewClassName:"grid place-items-center",source:[{name:`${He}.tsx`,content:Xi,lang:"tsx"}],usage:[{name:`${He}-preview.tsx`,content:Ui,lang:"tsx"}],componentsAPI:[{name:"Tilt3D",props:be},{name:"Tilt3DElement",props:ve}]}),es=`import { createContext, useContext, useState, type ComponentProps, useCallback, memo, type CSSProperties } from "react";
import { motion, type HTMLMotionProps } from "motion/react";
import cn from "@/utils/cn";
...
export default memo(TiltCarousel);`,ns=`import TiltImageCarousel from "@/registry/components/tilt-image-carousel/tilt-image-carousel";
...
export default memo(DecryptingTextAnimation);`,hs=`import DecryptingTextAnimation from "@/registry/text-effects/decrypting-text-animation/decrypting-text-animation";
...
export default memo(RollingLettersAnimation);`,gs=`import RollingLettersAnimation from "@/registry/text-effects/rolling-letters-animation/rolling-letters-animation";
...
export default RollingLettersAnimationPreview;`,ys={},xs={};function tt(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"text"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:"The text to display and animate with the rolling letter effect."})]}),n(e.tr,{children:[n(e.td,{children:"blockWidth"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"16"})}),n(e.td,{children:["Width of each letter container. Helps maintain consistent horizontal spacing when fonts are not monospace. Typically set to match the text ",n(e.code,{children:"font-size"}),"."]})]}),n(e.tr,{children:[n(e.td,{children:"blockHeight"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"Yes"}),n(e.td,{children:n(e.code,{children:"16"})}),n(e.td,{children:["Height of each letter container. Helps maintain consistent vertical alignment and spacing. Typically set to match the text ",n(e.code,{children:"font-size"}),"."]})]}),n(e.tr,{children:[n(e.td,{children:"blockGap"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"0"})}),n(e.td,{children:"Horizontal gap between adjacent letter containers. Useful for fine-tuning the spacing between characters."})]}),n(e.tr,{children:[n(e.td,{children:"duration"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"2"})}),n(e.td,{children:["Total animation duration in seconds. Minimum value: ",n(e.code,{children:"0.1"}),"."]})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS class applied to the root container element."})]}),n(e.tr,{children:[n(e.td,{children:"style"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to the root container element."})]}),n(e.tr,{children:[n(e.td,{children:"blockClassName"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"CSS class applied to each individual letter block element. Useful for custom letter styling or effects."})]}),n(e.tr,{children:[n(e.td,{children:"blockStyle"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to each letter block element."})]})]})]})}function bs(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(tt,{...t})}):tt(t)}const Se=(t={})=>bs({...t,components:{Fragment:f,...t.components}});Se[Symbol.for("mdx-component")]=!0;Se[Symbol.for("astro.needsHeadRendering")]=!xs.layout;Se.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/text-effects/rolling-letters-animation/props.mdx";const Y="rolling-letters-animation",rt=x({id:Y,name:"Rolling Letters",description:"Displays a word where each character animates with a vertical rolling effect, creating a dynamic text reveal.",category:p.textEffect.id,dependencies:[m.motion.key,m.tailwind.key],preview:ys,previewClassName:"grid place-items-center",source:[{name:`${Y}.tsx`,content:fs,lang:"tsx"}],usage:[{name:`${Y}-preview.tsx`,content:gs,lang:"tsx"}],componentsAPI:[{name:`${Y}.tsx`,props:Se}]}),vs=`import { memo, useMemo } from "react";
import { motion } from "motion/react";
import cn from "@/utils/cn";
...
export default memo(TextEmergeAnimation);`,Ns=`import TextEmergeAnimation from "@/registry/text-effects/text-emerge-animation/text-emerge-animation";
...
`,zs=`import TypewriterAnimation from "@/registry/text-effects/typewriter-animation/typewriter-animation";
...
export default memo(VerticalTextSlider);`,Ds=`import VerticalTextSlider from "@/registry/text-effects/vertical-text-slider/vertical-text-slider";
...
export default memo(AuroraBorder);`,Bs=`import AuroraBorder from "@/registry/visual-effects/aurora-border/aurora-border";
...
export default memo(BorderBeam);`,Vs=`import BorderBeam from "@/registry/visual-effects/border-beam/border-beam";
...
export default memo(SpotlightCardsContainer);`,Js=`import SpotlightCardsContainer, { SpotlightCard }  from "@/registry/visual-effects/spotlight-card/spotlight-card";
import cn from "@/utils/cn";
...
export default SpotlightCardPreview;`,Gs={},Ks={};function gt(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:["One or more ",n(e.code,{children:"SpotlightCard"})," components to be rendered inside the container."]})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the container."})]}),n(e.tr,{children:[n(e.td,{children:"style"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to the container element."})]})]})]})}function Qs(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(gt,{...t})}):gt(t)}const Te=(t={})=>Qs({...t,components:{Fragment:f,...t.components}});Te[Symbol.for("mdx-component")]=!0;Te[Symbol.for("astro.needsHeadRendering")]=!Ks.layout;Te.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/visual-effects/spotlight-card/SpotlightCardsContainer-props.mdx";const ec={};function yt(t){const e={code:"code",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...t.components};return n(e.table,{children:[n(e.thead,{children:n(e.tr,{children:[n(e.th,{children:"Prop"}),n(e.th,{children:"Type"}),n(e.th,{children:"Required"}),n(e.th,{children:"Default"}),n(e.th,{children:"Description"})]})}),n(e.tbody,{children:[n(e.tr,{children:[n(e.td,{children:"children"}),n(e.td,{children:n(e.code,{children:"React.ReactNode"})}),n(e.td,{children:"Yes"}),n(e.td,{children:"—"}),n(e.td,{children:"Content to be rendered inside the card."})]}),n(e.tr,{children:[n(e.td,{children:"spotlightColor"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:'"rgb(127, 127, 127)"'})}),n(e.td,{children:"Spotlight color. Accepts RGB or HEX; alpha channel is used to control spotlight intensity."})]}),n(e.tr,{children:[n(e.td,{children:"spotlightSize"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"100"})}),n(e.td,{children:"Size of the spotlight effect in pixels."})]}),n(e.tr,{children:[n(e.td,{children:"spotlightBorderWidth"}),n(e.td,{children:n(e.code,{children:"number"})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"1"})}),n(e.td,{children:"Width of the card border in pixels; adopts spotlight color on hover proximity."})]}),n(e.tr,{children:[n(e.td,{children:"className"}),n(e.td,{children:n(e.code,{children:"string"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Additional CSS classes applied to the card."})]}),n(e.tr,{children:[n(e.td,{children:"style"}),n(e.td,{children:n(e.code,{children:"React.CSSProperties"})}),n(e.td,{children:"No"}),n(e.td,{children:"—"}),n(e.td,{children:"Inline styles applied to the card."})]}),n(e.tr,{children:[n(e.td,{children:"wrapperProps"}),n(e.td,{children:n(e.code,{children:'React.ComponentProps<"div">'})}),n(e.td,{children:"No"}),n(e.td,{children:n(e.code,{children:"{}"})}),n(e.td,{children:["Props passed to the wrapper element (e.g., ",n(e.code,{children:"className"}),", ",n(e.code,{children:"style"}),", etc.)."]})]})]})]})}function nc(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(yt,{...t})}):yt(t)}const $e=(t={})=>nc({...t,components:{Fragment:f,...t.components}});$e[Symbol.for("mdx-component")]=!0;$e[Symbol.for("astro.needsHeadRendering")]=!ec.layout;$e.moduleId="/home/runner/work/MosaicUI/MosaicUI/src/docs/visual-effects/spotlight-card/SpotlightCard-props.mdx";const Be="spotlight-card",xt=x({id:Be,name:"Spotlight Card",description:"A container for interactive cards with a hover spotlight effect, ideal for showcasing features or highlights.",category:p.visualEffects.id,dependencies:[m.tailwind.key],preview:Gs,previewClassName:"grid place-items-center",source:[{name:`${Be}.tsx`,content:Ys,lang:"tsx"}],usage:[{name:`${Be}-preview.tsx`,content:Js,lang:"tsx"}],componentsAPI:[{name:"SpotlightCardsContainer",props:Te},{name:"SpotlightCard",props:$e}]}),Ht={[p.component.key]:{[Tn.id]:Tn,[An.id]:An,[On.id]:On,[Ln.id]:Ln,[Fn.id]:Fn,[Wn.id]:Wn,[Zn.id]:Zn,[Yn.id]:Yn,[Gn.id]:Gn},[p.textEffect.key]:{[Qn.id]:Qn,[nt.id]:nt,[rt.id]:rt,[it.id]:it,[ct.id]:ct,[dt.id]:dt,[ht.id]:ht},[p.background.key]:{[Nn.id]:Nn,[Pn.id]:Pn,[_n.id]:_n},[p.visualEffects.key]:{[mt.id]:mt,[ft.id]:ft,[xt.id]:xt}};Object.values(Ht).reduce((t,e)=>({...t,...e}),{});const bt=Object.freeze([{label:"Get Started",entries:[{label:"Introduction",href:"/introduction/"},{label:"Installation",href:"/installation/"},{label:"Components",href:"/components/"}]},...Object.entries(Ht).map(([t,e])=>({label:p[t].name,entries:Object.values(e).map(r=>({label:r.name,href:`/components/${r.id}/`}))}))]),tc=(t,e)=>t.replace(/\/$/,"")===e.replace(/\/$/,""),lc=({activePath:t=""})=>{const[e,r]=Ae.useState(!1),o=Ae.useCallback(()=>{r(!0)},[]);return Ae.useEffect(()=>(document.documentElement.addEventListener("sidebar-open",o),()=>{document.documentElement.removeEventListener("sidebar-open",o)}),[o]),M.jsx(jt,{children:e&&M.jsxs(M.Fragment,{children:[M.jsx(Je.div,{className:"h-screen md:h-[calc(100%_-_32px)] w-[280px] top-0 left-0 md:top-[16px] md:left-[16px] bg-white dark:bg-neutral-950 fixed z-[102] rounded-md overflow-y-auto border border-zinc-300 dark:border-zinc-900",style:{x:-100,opacity:0},animate:{x:e?0:-320,opacity:e?1:0},exit:{x:-100,opacity:0},transition:{ease:"circInOut",type:"tween",duration:.3},children:bt.map((i,c)=>M.jsxs(M.Fragment,{children:[M.jsxs("div",{className:"py-4",children:[M.jsx("span",{className:"text-gray-800 dark:text-gray-200 px-3 block mb-2 font-semibold",children:i.label}),M.jsx("ul",{children:i.entries.map(s=>M.jsx("li",{children:M.jsx("a",{href:s.href,className:`${tc(t,s.href)?"text-blue-600 bg-blue-600/10 dark:text-blue-500 hover:text-blue-600 hover:dark:text-blue-500":"text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"}  block py-[4px] px-2 pl-4 cursor-pointer`,children:s.label})}))})]}),c!==bt.length-1&&M.jsx("div",{className:"h-[1px] bg-zinc-200 dark:bg-zinc-900"})]}))}),M.jsx(Je.div,{className:"fixed top-0 left-0 w-full h-full z-[101] inset-[0] backdrop-blur-[5px]",onTap:()=>r(!1)})]})})};export{lc as default};
