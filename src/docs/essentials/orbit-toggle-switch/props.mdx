...
|---------------|--------------------------------|----------|---------|-------------|
| aria-label | `string` | No       | —       | Accessible label that provides a descriptive name for the component. Helps assistive technologies understand the purpose of the toggle switch. |
